...
def meter_values_request_flatten(input_df: DataFrame):
    ### YOUR CODE HERE
    selected_column_names: List[str] = ["message_id", "message_type", "charge_point_id", "action", "write_timestamp", "transaction_id",
                                        "connector_id", "timestamp", "measurand", "phase", "value"]
